...
$(document).ready(function() {
  $("form#add").submit(function(event) {
    ...
    var number2 = parseInt($("#add3").val());
    var number2 = parseInt($("#add4").val());
    var number2 = parseInt($("#add5").val());
    var number2 = parseInt($("#add6").val());
    var number2 = parseInt($("#add7").val());
    var number2 = parseInt($("#add8").val());
    var number2 = parseInt($("#add9").val());
    var number2 = parseInt($("#add10").val());
    var number2 = parseInt($("#add11").val());
    var number2 = parseInt($("#add12").val());
    var number2 = parseInt($("#add13").val());
    var number2 = parseInt($("#add14").val());
    var number2 = parseInt($("#add15").val());
